...
export type MockMember = Omit<
  Members,
  'sector_id' | 'cell_id' | 'zone_id' | 'sub_sector_id' | 'network_id'
> & {
...
export const mockChurches: MockChurch[] = [
  ...
  },
  {
    ...
    updatedAt: new Date('2024-10-30'),
    owner_id: null,
    email: 'info@vidanueva.mx',
    phone: '+52 33 1234 5678',
    street: 'Av. Vallarta 456',
    city: 'Guadalajara',
    state: 'Jalisco',
    zip: '44100',
    country: 'México',
  ...
  },
  {
    ...
    updatedAt: new Date('2024-10-30'),
    owner_id: null,
    email: 'contacto@emanuel.org',
    phone: '+52 81 1234 5678',
    street: 'Av. Constitución 789',
    city: 'Monterrey',
    state: 'Nuevo León',
    zip: '64000',
    country: 'México',
