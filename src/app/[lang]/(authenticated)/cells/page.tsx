    ...
    },
    {
      ...
      render: (value, row) => {
        ...
        if (row.sectorId) {
          return (
            <Link
              href={`/${lang}/sectors/edit/${row.sectorId}`}
    ...
    },
    {
      ...
      render: (value, row) => {
        ...
        if (row.leaderId) {
          return (
            <Link
              href={`/${lang}/members/edit/${row.leaderId}`}
              className="hover:underline text-primary"
            >
              {name}
            </Link>
    ...
    },
    {
      ...
      render: (value, row) => {
        ...
        if (row.hostName && row.hostId) {
          return (
            <Link
              href={`/${lang}/members/edit/${row.hostId}`}
              className="hover:underline text-primary"
            >
              {name}
            </Link>
    ...
    },
    {
      ...
      render: (value, row) => {
        ...
        if (row.assistantName && row.assistantId) {
          return (
            <Link
              href={`/${lang}/members/edit/${row.assistantId}`}
              className="hover:underline text-primary"
            >
              {name}
            </Link>
  ...
  const actions: TableAction<CellTableData>[] = [
    {
      label: 'Editar',
      variant: 'ghost',
      onClick: (cell) => router.push(`/${lang}/cells/edit/${cell.id}`),
    },
    {
      label: 'Eliminar',
      variant: 'ghost',
